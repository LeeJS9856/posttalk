...
export const PreviewVideo = styled.video`width: 100%; aspect-ratio: 9 / 16; max-height: 52svh; margin-top: 16px; border-radius: 14px; background: ${COLORS.black700}; object-fit: cover;`;
